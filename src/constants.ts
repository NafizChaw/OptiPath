...
export const WELCOME_MESSAGE = '  Optipath is the ultimate route optimization app designed to help you plan efficient journeys to multiple\n' +
    ...
    '  the app analyzes distances, traffic patterns, and road conditions to suggest the most efficient path, saving you time\n' +
    '  and fuel costs. Simply enter your destinations, and let RouteMaster do the work, providing turn-by-turn navigation and\n' +
    '  real-time updates. Make every trip quicker, easier, and more productive with RouteMaster.'
